# 🔐 Sekersoft Lisans Sistemi

## Genel Bakış

Sekersoft uygulaması artık **hardware-based (donanım bazlı)** bir lisans sistemi ile korunmaktadır. Bu sistem, yazılımın yetkisiz kopyalanmasını ve kullanılmasını engeller.
