...
Bu rehber, Seymen Transport uygulaması için Windows installer (setup.exe) oluşturma adımlarını içerir.
...
```
📁 release/
   └── Seymen Transport-Setup-1.0.0.exe
```
...
```
**Çıktı:**
- `Seymen Transport-Setup-1.0.0.exe` (NSIS Installer)
- `Seymen Transport 1.0.0.exe` (Portable)
...
```
**Çıktı:**
- `Seymen Transport 1.0.0.exe` (Kurulum gerektirmez)
...
✔ Building NSIS installer                  
  ...
  • writing installer  file=release\Seymen Transport-Setup-1.0.0.exe
```
...
```
release/
├── Seymen Transport-Setup-1.0.0.exe      # NSIS Installer (Önerilen)
├── Seymen Transport 1.0.0.exe            # Portable sürüm
...
#### NSIS Installer (`Seymen Transport-Setup-1.0.0.exe`)
✅ **Özellikler:**
...
- `Seymen Transport-Setup-1.0.1.exe` oluşur
...
```
📦 release/Seymen Transport-Setup-1.0.0.exe
```
